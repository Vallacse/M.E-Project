    ...
    public class DataAccess : IDataAccess
    {
        ...
        public int InsertProduct(Product product)
        {
            ...
            using SqlConnection connection = new(dbconnection);
            {
                ...
                string query1 = @"INSERT INTO Products (ProductId, Title, Description, CategoryId, OfferId, Price, Quantity, ImageName) 
                                VALUES (@prid, @tit, @de, @caid, @oid, @pe, @qty, @imgn)";
                string query2 = @"set identity_insert Products off";

                command.CommandText = query;
                command.CommandText = query1;
                command.Parameters.Add("@prid", System.Data.SqlDbType.Int).Value = product.Id;
                command.Parameters.Add("@tit", System.Data.SqlDbType.NVarChar).Value = product.Title;
                command.Parameters.Add("@de", System.Data.SqlDbType.NVarChar).Value = product.Description;
                command.Parameters.Add("@caid", System.Data.SqlDbType.Int).Value = product.ProductCategory.Id;
                command.Parameters.Add("@oid", System.Data.SqlDbType.Int).Value = product.Offer.Id;
                command.Parameters.Add("@pe", System.Data.SqlDbType.Float).Value = product.Price;
                command.Parameters.Add("@qty", System.Data.SqlDbType.Int).Value = product.Quantity;
                command.Parameters.Add("@imgn", System.Data.SqlDbType.NVarChar).Value = product.ImageName;
        ...
        public bool RemoveCartItem(int userId, int productId)
        {
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                connection.Open();
                string query = "Delete FROM Carts WHERE UserId=" + userId + " AND Ordered='false';";
                command.CommandText = query;
                command.ExecuteNonQuery();
                return true;
            }
